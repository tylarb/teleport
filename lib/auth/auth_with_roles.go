...
func (a *WithRoles) actionWithContext(ctx *services.Context, namespace string, resource string, action string) error {
...
func (a *WithRoles) hasLocalUserRole(checker services.AccessChecker) bool {
...
func (a *WithRoles) AuthenticateWebUser(req AuthenticateUserRequest) (services.WebSession, error) {
...
func (a *WithRoles) CreateCertAuthority(ca services.CertAuthority) error {
...
func (a *WithRoles) RotateExternalCertAuthority(ca services.CertAuthority) error {
	if ca == nil {
...
func (a *WithRoles) UpsertCertAuthority(ca services.CertAuthority) error {
	if ca == nil {
		return trace.BadParameter("missing certificate authority")
	}
	ctx := &services.Context{User: a.context.User, Resource: ca}
...
func (a *WithRoles) CompareAndSwapCertAuthority(new, existing services.CertAuthority) error {
	if err := a.action(defaults.Namespace, services.KindCertAuthority, services.VerbCreate); err != nil {
		return trace.Wrap(err)
	}
	if err := a.action(defaults.Namespace, services.KindCertAuthority, services.VerbUpdate); err != nil {
...
func (a *WithRoles) GetCertAuthorities(caType services.CertAuthType, loadKeys bool, opts ...services.MarshalOption) ([]services.CertAuthority, error) {
...
func (a *WithRoles) GetCertAuthority(id services.CertAuthID, loadKeys bool, opts ...services.MarshalOption) (services.CertAuthority, error) {
	if err := a.action(defaults.Namespace, services.KindCertAuthority, services.VerbReadNoSecrets); err != nil {
		return nil, trace.Wrap(err)
	}
	if loadKeys {
...
func (a *WithRoles) DeleteCertAuthority(id services.CertAuthID) error {
...
func (a *WithRoles) ActivateCertAuthority(id services.CertAuthID) error {
	return trace.NotImplemented("not implemented")
}

func (a *WithRoles) DeactivateCertAuthority(id services.CertAuthID) error {
	return trace.NotImplemented("not implemented")
}
...
func (a *WithRoles) UpsertNodes(namespace string, servers []services.Server) error {
...
func (a *WithRoles) UpsertNode(s services.Server) (*services.KeepAlive, error) {
...
func (a *WithRoles) KeepAliveNode(ctx context.Context, handle services.KeepAlive) error {
...
func (a *WithRoles) NewWatcher(ctx context.Context, watch services.Watch) (services.Watcher, error) {
...
func (a *WithRoles) filterNodes(nodes []services.Server) ([]services.Server, error) {
...
func (a *WithRoles) GetNodes(namespace string, opts ...services.MarshalOption) ([]services.Server, error) {
...
func (a *WithRoles) UpsertAuthServer(s services.Server) error {
	if err := a.action(defaults.Namespace, services.KindAuthServer, services.VerbCreate); err != nil {
		return trace.Wrap(err)
	}
	if err := a.action(defaults.Namespace, services.KindAuthServer, services.VerbUpdate); err != nil {
...
func (a *WithRoles) GetAuthServers() ([]services.Server, error) {
...
func (a *WithRoles) UpsertProxy(s services.Server) error {
...
func (a *WithRoles) GetProxies() ([]services.Server, error) {
...
func (a *WithRoles) UpsertReverseTunnel(r services.ReverseTunnel) error {
...
func (a *WithRoles) GetReverseTunnel(name string, opts ...services.MarshalOption) (services.ReverseTunnel, error) {
	if err := a.action(defaults.Namespace, services.KindReverseTunnel, services.VerbRead); err != nil {
		return nil, trace.Wrap(err)
	}
...
func (a *WithRoles) GetReverseTunnels(opts ...services.MarshalOption) ([]services.ReverseTunnel, error) {
...
func (a *WithRoles) GetTokens(opts ...services.MarshalOption) ([]services.ProvisionToken, error) {
...
func (a *WithRoles) GetToken(token string) (services.ProvisionToken, error) {
	if err := a.action(defaults.Namespace, services.KindToken, services.VerbRead); err != nil {
		return nil, trace.Wrap(err)
	}
...
func (a *WithRoles) UpsertToken(token services.ProvisionToken) error {
	if err := a.action(defaults.Namespace, services.KindToken, services.VerbCreate); err != nil {
		return trace.Wrap(err)
	}
...
func (a *WithRoles) ChangePassword(req services.ChangePasswordReq) error {
...
func (a *WithRoles) UpsertTOTP(user string, otpSecret string) error {
	if err := a.currentUserAction(user); err != nil {
		return trace.Wrap(err)
	}
...
func (a *WithRoles) PreAuthenticatedSignIn(user string) (services.WebSession, error) {
	if err := a.currentUserAction(user); err != nil {
		return nil, trace.Wrap(err)
	}
...
func (a *WithRoles) GetU2FSignRequest(user string, password []byte) (*u2f.SignRequest, error) {
...
func (a *WithRoles) CreateWebSession(user string) (services.WebSession, error) {
	if err := a.currentUserAction(user); err != nil {
		return nil, trace.Wrap(err)
	}
...
func (a *WithRoles) ExtendWebSession(user, prevSessionID string) (services.WebSession, error) {
	if err := a.currentUserAction(user); err != nil {
		return nil, trace.Wrap(err)
	}
...
func (a *WithRoles) GetWebSessionInfo(user string, sid string) (services.WebSession, error) {
	if err := a.currentUserAction(user); err != nil {
		return nil, trace.Wrap(err)
	}
...
func (a *WithRoles) DeleteWebSession(user string, sid string) error {
	if err := a.currentUserAction(user); err != nil {
		return trace.Wrap(err)
	}
...
func (a *WithRoles) GetAccessRequests(ctx context.Context, filter services.AccessRequestFilter) ([]services.AccessRequest, error) {
...
func (a *WithRoles) CreateAccessRequest(ctx context.Context, req services.AccessRequest) error {
...
func (a *WithRoles) SetAccessRequestState(ctx context.Context, reqID string, state services.RequestState) error {
...
func (a *WithRoles) GetPluginData(ctx context.Context, filter services.PluginDataFilter) ([]services.PluginData, error) {
	switch filter.Kind {
	case services.KindAccessRequest:
		if err := a.action(defaults.Namespace, services.KindAccessRequest, services.VerbList); err != nil {
			return nil, trace.Wrap(err)
...
func (a *WithRoles) UpdatePluginData(ctx context.Context, params services.PluginDataUpdateParams) error {
	switch params.Kind {
	case services.KindAccessRequest:
		if err := a.action(defaults.Namespace, services.KindAccessRequest, services.VerbUpdate); err != nil {
			return trace.Wrap(err)
...
func (a *WithRoles) GetUsers(withSecrets bool) ([]services.User, error) {
	if withSecrets {
...
func (a *WithRoles) GetUser(name string, withSecrets bool) (services.User, error) {
	if withSecrets {
		// TODO(fspmarshall): replace admin requirement with VerbReadWithSecrets once we've
		// migrated to that model.
		if !a.hasBuiltinRole(string(teleport.RoleAdmin)) {
...
func (a *WithRoles) NewKeepAliver(ctx context.Context) (services.KeepAliver, error) {
...
func (a *WithRoles) GetSignupU2FRegisterRequest(token string) (u2fRegisterRequest *u2f.RegisterRequest, e error) {
	// signup token are their own authz resource
	return a.authServer.CreateSignupU2FRegisterRequest(token)
}

func (a *WithRoles) CreateResetPasswordToken(ctx context.Context, req CreateResetPasswordTokenRequest) (services.ResetPasswordToken, error) {
...
func (a *WithRoles) GetResetPasswordToken(ctx context.Context, tokenID string) (services.ResetPasswordToken, error) {
	// tokens are their own authz mechanism, no need to double check
	return a.authServer.GetResetPasswordToken(ctx, tokenID)
}

func (a *WithRoles) RotateResetPasswordTokenSecrets(ctx context.Context, tokenID string) (services.ResetPasswordTokenSecrets, error) {
	// tokens are their own authz mechanism, no need to double check
	return a.authServer.RotateResetPasswordTokenSecrets(ctx, tokenID)
}

func (a *WithRoles) ChangePasswordWithToken(ctx context.Context, req ChangePasswordWithTokenRequest) (services.WebSession, error) {
	// Token is it's own authentication, no need to double check.
	return a.authServer.ChangePasswordWithToken(ctx, req)
}

// CreateUser inserts a new user entry in a backend.
func (a *WithRoles) CreateUser(ctx context.Context, user services.User) error {
...
func (a *WithRoles) UpdateUser(ctx context.Context, user services.User) error {
	if err := a.action(defaults.Namespace, services.KindUser, services.VerbUpdate); err != nil {
		return trace.Wrap(err)
	}
...
func (a *WithRoles) UpsertUser(u services.User) error {
	if err := a.action(defaults.Namespace, services.KindUser, services.VerbCreate); err != nil {
		return trace.Wrap(err)
	}
	if err := a.action(defaults.Namespace, services.KindUser, services.VerbUpdate); err != nil {
...
func (a *WithRoles) UpsertOIDCConnector(ctx context.Context, connector services.OIDCConnector) error {
...
func (a *WithRoles) GetOIDCConnector(id string, withSecrets bool) (services.OIDCConnector, error) {
...
func (a *WithRoles) GetOIDCConnectors(withSecrets bool) ([]services.OIDCConnector, error) {
...
func (a *WithRoles) CreateOIDCAuthRequest(req services.OIDCAuthRequest) (*services.OIDCAuthRequest, error) {
...
func (a *WithRoles) CreateSAMLConnector(ctx context.Context, connector services.SAMLConnector) error {
...
func (a *WithRoles) UpsertSAMLConnector(ctx context.Context, connector services.SAMLConnector) error {
	if err := a.authConnectorAction(defaults.Namespace, services.KindSAML, services.VerbCreate); err != nil {
		return trace.Wrap(err)
	}
...
func (a *WithRoles) GetSAMLConnector(id string, withSecrets bool) (services.SAMLConnector, error) {
...
func (a *WithRoles) GetSAMLConnectors(withSecrets bool) ([]services.SAMLConnector, error) {
...
func (a *WithRoles) CreateSAMLAuthRequest(req services.SAMLAuthRequest) (*services.SAMLAuthRequest, error) {
...
func (a *WithRoles) CreateGithubConnector(connector services.GithubConnector) error {
...
func (a *WithRoles) UpsertGithubConnector(ctx context.Context, connector services.GithubConnector) error {
	if err := a.authConnectorAction(defaults.Namespace, services.KindGithub, services.VerbCreate); err != nil {
		return trace.Wrap(err)
	}
...
func (a *WithRoles) GetGithubConnector(id string, withSecrets bool) (services.GithubConnector, error) {
...
func (a *WithRoles) GetGithubConnectors(withSecrets bool) ([]services.GithubConnector, error) {
...
func (a *WithRoles) CreateGithubAuthRequest(req services.GithubAuthRequest) (*services.GithubAuthRequest, error) {
...
func (a *WithRoles) GetNamespaces() ([]services.Namespace, error) {
...
func (a *WithRoles) GetNamespace(name string) (*services.Namespace, error) {
	if err := a.action(defaults.Namespace, services.KindNamespace, services.VerbRead); err != nil {
		return nil, trace.Wrap(err)
	}
...
func (a *WithRoles) UpsertNamespace(ns services.Namespace) error {
...
func (a *WithRoles) GetRoles() ([]services.Role, error) {
...
func (a *WithRoles) CreateRole(role services.Role) error {
	return trace.NotImplemented("not implemented")
}

// UpsertRole creates or updates role.
func (a *WithRoles) UpsertRole(ctx context.Context, role services.Role) error {
...
func (a *WithRoles) GetRole(name string) (services.Role, error) {
...
func (a *WithRoles) GetClusterConfig(opts ...services.MarshalOption) (services.ClusterConfig, error) {
	if err := a.action(defaults.Namespace, services.KindClusterConfig, services.VerbRead); err != nil {
		return nil, trace.Wrap(err)
	}
...
func (a *WithRoles) SetClusterConfig(c services.ClusterConfig) error {
...
func (a *WithRoles) GetClusterName(opts ...services.MarshalOption) (services.ClusterName, error) {
	if err := a.action(defaults.Namespace, services.KindClusterName, services.VerbRead); err != nil {
		return nil, trace.Wrap(err)
	}
...
func (a *WithRoles) SetClusterName(c services.ClusterName) error {
...
func (a *WithRoles) UpsertClusterName(c services.ClusterName) error {
	if err := a.action(defaults.Namespace, services.KindClusterName, services.VerbCreate); err != nil {
		return trace.Wrap(err)
	}
	if err := a.action(defaults.Namespace, services.KindClusterName, services.VerbUpdate); err != nil {
...
func (a *WithRoles) GetStaticTokens() (services.StaticTokens, error) {
	if err := a.action(defaults.Namespace, services.KindStaticTokens, services.VerbRead); err != nil {
		return nil, trace.Wrap(err)
	}
...
func (a *WithRoles) SetStaticTokens(s services.StaticTokens) error {
...
func (a *WithRoles) GetAuthPreference() (services.AuthPreference, error) {
...
func (a *WithRoles) SetAuthPreference(cap services.AuthPreference) error {
...
func (a *WithRoles) DeleteAllTokens() error {
	return trace.NotImplemented("not implemented")
}

// DeleteAllCertAuthorities deletes all certificate authorities of a certain type
func (a *WithRoles) DeleteAllCertAuthorities(caType services.CertAuthType) error {
	return trace.NotImplemented("not implemented")
}

// DeleteAllCertNamespaces deletes all namespaces
func (a *WithRoles) DeleteAllNamespaces() error {
	return trace.NotImplemented("not implemented")
}

// DeleteAllReverseTunnels deletes all reverse tunnels
func (a *WithRoles) DeleteAllReverseTunnels() error {
	return trace.NotImplemented("not implemented")
}

// DeleteAllRoles deletes all roles
func (a *WithRoles) DeleteAllRoles() error {
	return trace.NotImplemented("not implemented")
}

// DeleteAllUsers deletes all users
func (a *WithRoles) DeleteAllUsers() error {
	return trace.NotImplemented("not implemented")
}

func (a *WithRoles) GetTrustedClusters() ([]services.TrustedCluster, error) {
...
func (a *WithRoles) GetTrustedCluster(name string) (services.TrustedCluster, error) {
	if err := a.action(defaults.Namespace, services.KindTrustedCluster, services.VerbRead); err != nil {
		return nil, trace.Wrap(err)
	}
...
func (a *WithRoles) UpsertTrustedCluster(ctx context.Context, tc services.TrustedCluster) (services.TrustedCluster, error) {
...
func (a *WithRoles) UpsertTunnelConnection(conn services.TunnelConnection) error {
...
func (a *WithRoles) GetTunnelConnections(clusterName string, opts ...services.MarshalOption) ([]services.TunnelConnection, error) {
...
func (a *WithRoles) GetAllTunnelConnections(opts ...services.MarshalOption) ([]services.TunnelConnection, error) {
	if err := a.action(defaults.Namespace, services.KindTunnelConnection, services.VerbList); err != nil {
		return nil, trace.Wrap(err)
	}
...
func (a *WithRoles) CreateRemoteCluster(conn services.RemoteCluster) error {
...
func (a *WithRoles) UpdateRemoteCluster(ctx context.Context, conn services.RemoteCluster) error {
	return trace.NotImplemented("not implemented: remote clusters can only be updated by auth server locally")
}

func (a *WithRoles) GetRemoteCluster(clusterName string) (services.RemoteCluster, error) {
...
func (a *WithRoles) GetRemoteClusters(opts ...services.MarshalOption) ([]services.RemoteCluster, error) {
...
func (a *WithRoles) AcquireSemaphore(ctx context.Context, params services.AcquireSemaphoreRequest) (*services.SemaphoreLease, error) {
...
func (a *WithRoles) KeepAliveSemaphoreLease(ctx context.Context, lease services.SemaphoreLease) error {
	if err := a.action(defaults.Namespace, services.KindSemaphore, services.VerbUpdate); err != nil {
		return trace.Wrap(err)
	}
...
func (a *WithRoles) CancelSemaphoreLease(ctx context.Context, lease services.SemaphoreLease) error {
	if err := a.action(defaults.Namespace, services.KindSemaphore, services.VerbUpdate); err != nil {
		return trace.Wrap(err)
	}
...
func (a *WithRoles) GetSemaphores(ctx context.Context, filter services.SemaphoreFilter) ([]services.Semaphore, error) {
...
func (a *WithRoles) DeleteSemaphore(ctx context.Context, filter services.SemaphoreFilter) error {
